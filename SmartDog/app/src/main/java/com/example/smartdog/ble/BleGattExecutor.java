...
class BleGattExecutor extends BluetoothGattCallback {
    ...
    private final LinkedList<BleGattExecutor.ServiceAction> queue = new LinkedList<ServiceAction>();        // list of actions to execute
    ...
    static BleGattExecutor createExecutor(final BleExecutorListener listener) {
        return new BleGattExecutor() {
            ...
            public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
                ...
                listener.onConnectionStateChange(gatt, newState);
            }
            ...
            public void onDescriptorRead(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
                super.onDescriptorRead(gatt, descriptor, status);
                listener.onDescriptorRead(descriptor, status);
            }
    ...
    interface BleExecutorListener {
        ...
        void onConnectionStateChange(BluetoothGatt gatt, int newState);
